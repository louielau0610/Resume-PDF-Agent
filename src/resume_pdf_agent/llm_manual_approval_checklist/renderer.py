"""HTML renderer for M28 manual approval checklist (static local page)."""
...
def render_manual_approval_checklist_html(report: LLMManualApprovalChecklistReport) -> str:
    env = _create_env()
    template = env.get_template("manual_approval_checklist.html.j2")
    ctx = {
        "report": report,
        "css": _read_static("manual_approval_checklist.css"),
        "js": _read_static("manual_approval_checklist.js"),
