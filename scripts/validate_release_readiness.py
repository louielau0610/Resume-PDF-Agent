...
_REQUIRED_DOCS: list[str] = [
    ...
    "docs/llm_pre_application_validation_v0.md",
    "docs/llm_manual_patch_preview_v0.md",
    "docs/llm_manual_approval_checklist_v0.md",
    "docs/llm_human_final_edit_instruction_pack_v0.md",
    "docs/release_validation_report_v0.md",
    "docs/launch_notes_v0.md",
    "docs/promotion_copy_v0.md",
